			...
			<div className="container">
				<div className="flex flex-col items-center mb-10 md:mt-20">
					...
					<div className="relative flex flex-col gap-1 rounded-3xl items-center w-[22rem] h-[22rem] md:scale-[125%] -mt-16 md:-mt-20">
						...
						></div>
						<div className="flex flex-row items-end justify-between w-[115%] h-full gap-x-[0.06rem] bg-gradient-to-b from-transparent from-50% via-black/30 via-80% to-black/80">
							...
							<div className="relative flex flex-col items-center h-48 w-8 bg-blue-500 book">
								<div
									className="absolute inset-0 w-full h-full top-0 left-0 z-0 opacity-10 bg-auto"
									style={{
										backgroundImage: `url(${matte2.src})`,
								...
								></div>
								<div className="scale-50">
									<SvgIcon component={ReactIcon} color="fill-gray-300/80" />
								</div>
								<div className="-mt-2 w-48 font-serif font-base text-sm tracking-tight rotate-90 translate-y-24 text-gray-300/70">
							...
							<div className="relative flex flex-col items-center justify-between h-48 w-7 bg-teal-600 book">
								<div
									className="absolute inset-0 w-full h-full top-0 left-0 z-0 opacity-10 bg-cover"
									style={{
										backgroundImage: `url(${leather1.src})`,
								...
								<div className="w-32 font-sans font-semibold tracking-widest text-sm rotate-90 translate-y-20 text-gray-300">
									<h1 className="[transform:scale(1,1.5)]">tailwind.</h1>
								</div>
								<div className="mt-20 mb-2"></div>
							</div>
							<div className="relative flex flex-col items-center h-60 w-8 bg-red-700 book rotate-2 mr-[0.4rem] ml-[0.025rem]">
								...
								<div className="mt-1 w-60 font-sono font-semibold text-sm rotate-90 translate-y-24 text-slate-200 text-center">
									<h1 className="">
										The <span className="text-orange-200">HTML</span> Cookbook
									</h1>
								</div>
								<div className="mt-20 mb-2"></div>
							</div>
						...
						<div className="relative z-[5] -mt-2 w-[150%] lg:w-[165%] h-12 rounded-md overflow-clip bg-gray-900 ">
							<div
						...
						<div className="flex flex-row justify-evenly gap-[12rem] w-[190%] h-12 -mt-28">
