...
import jtwrn_header from "@/assets/jtwrn_header.gif";
import jtwrn_foryou from "@/assets/jtwrn_foryou.gif";
import jtwrn_fromme from "@/assets/jtwrn_fromme.png";
import jtwrn_pages from "@/assets/jtwrn_pages.png";
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center w-[22rem] md:w-[44rem] gap-16">
            <div className="flex flex-col items-center justify-center inset-0 div-2 w-full overflow-clip shadow-lg shadow-reseda-green/20 border-taupe-gray/20 border-2">
              <a
                className="mt-2 font-sono font-bold tracking-base text-title underline underline-offset-2"
                href="https://jacksontrewern.com"
              >
                jacksontrewern.com
              </a>
              <div className="-mt-1 text-subheader text-base font-sono font-semibold tracking-tighter">
              ...
              <div className="text-subheader text-left text-sm font-sono tracking-tight px-4">
                <ul className="flex flex-col content-start gap-1">
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    swank, minimalist design that stands apart from cookie
                    cutter template sites
                  </li>
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    jackson is able to control what photos are shown via
                    Cloudinary integration!
                  </li>
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    first time working with a real client, an exercise in
              ...
              <div className="bg-gradient-to-t from-transparent to-gray-900 to-30% flex flex-col items-center">
                
                <div className="grid grid-cols-2 items-end">
                  <Image className="col-span-1" src={jtwrn_fromme} alt="catball gif" />
                  <Image className="col-span-1" src={jtwrn_foryou} alt="catball gif" />
                </div>
                <div>
                  <Image className="size-fit" src={jtwrn_header} alt="catball gif"/>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col pb-16 pt-48 w-[22rem] gap-2">
            <SectionHeader
          ...
          <div className="flex flex-col items-center w-[22rem] md:w-[44rem] gap-16">
            <div className="flex flex-col items-center justify-center inset-0 div-2 w-full overflow-clip shadow-lg shadow-reseda-green/20 border-taupe-gray/20 border-2">
              <div className="mt-2 font-sono font-bold tracking-wider text-title">
                "catball"
              </div>
              <div className="-mt-1 text-subheader text-base font-sono font-semibold tracking-tighter">
                a mobile game about cats
              </div>
              <hr className="w-3/4 border-1 border-taupe-gray border-dashed [mask-image:linear-gradient(to_left,transparent,black,transparent)] my-1" />
              <div className="flex flex-col items-center">
                <div className="text-subheader text-left text-sm font-sono tracking-tight px-4">
                  <ul className="flex flex-col content-start gap-1">
                    <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                      perfect 5-star rating on the apple app store
                    </li>
                    <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                      four original music tracks with option to change the
                      playback speed
                    </li>
                    <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                      50 unique levels with linear, roguelite progression
                    </li>
                  </ul>
                </div>
            ...
            <p hidden>OOO-OOO Project Card</p>
            <div className="flex flex-col items-center justify-center inset-0 div-2 w-full overflow-clip shadow-lg shadow-reseda-green/20 border-taupe-gray/20 border-2">
              <div className="mt-2 font-sono font-bold tracking-base text-title">
                "ooo-ooo.art"
              </div>
              <div className="-mt-1 text-subheader text-base font-sono font-semibold tracking-tighter">
                a web experiment about drawing
              </div>
              <hr className="w-3/4 border-1 border-taupe-gray border-dashed [mask-image:linear-gradient(to_left,transparent,black,transparent)] my-1" />
              <div className="text-subheader text-left text-sm font-sono tracking-tight px-4">
                <ul className="flex flex-col content-start gap-1">
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    CRUD functionality: post, save, delete, edit, etc.
                  </li>
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    users vote on a pool of daily drawings. highest scorers earn
                    a spot in the hall of fame.
                  </li>
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    {
                      'upvoted drawings are saved to a "liked tab", can be viewed anytime.'
                    }
                  </li>
                  <li className='inline-flex gap-2 before:[content:"\27A5"] before:text-base'>
                    now defunct proof of concept. domain and playerbase are inactive.
                  </li>
                </ul>
              </div>
              <hr className="w-3/4 border-1 border-taupe-gray border-dashed [mask-image:linear-gradient(to_left,transparent,black,transparent)] mt-1" />
              ...
              <div className="bg-black">
                <WebScreenshotCarousel screenshots={oooScreenshots} />
              </div>
            </div>
            <p hidden>Jackson Trewern project card</p>
          </div>
        </div>
      </div>
    </div>
